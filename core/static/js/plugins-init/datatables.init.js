...
(function($) {
	...
	var table = $('#attendance-tbl').DataTable({
		...
		buttons: [
			...
			{ extend: 'excel', text: '<i class="fa-solid fa-file-excel"></i> Descargar Excel',
              className: 'btn btn-sm border-0'
			}
        ],
		searching: false,
	...
	var table = $('#tabla-empleados').DataTable({
		...
		buttons: [
			...
			{ extend: 'excel', text: '<i class="fa-solid fa-file-excel"></i> Descargar Excel',
              className: 'btn-add-emp btn-sm border-0'
	...
	var table = $('#empoloyees-tbl').DataTable({
		...
		buttons: [
			...
			{ extend: 'excel', text: '<i class="fa-solid fa-file-excel"></i> Descargar en Excel',
              className: 'btn btn-sm border-0 float-right'
			}
        ],
		searching: false,
		select: true,   
	...
	var table = $('#empoloyees-tblwrapper').DataTable({
		...
		buttons: [
			...
			{ extend: 'excel', text: '<i class="fa-solid fa-file-excel"></i> Descargar Datos en Excel',
              className: 'btn btn-sm border-0'
			}
        ],
		searching: false,
